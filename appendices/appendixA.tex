...
The calculation uses the controlled directed acyclic graph shown in
Figure~\ref{fig:appendix-sample-network}. Its directed relations are
...
\input{figures/fig_appendix_sample_network}
