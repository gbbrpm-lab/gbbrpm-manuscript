...
\endfirsthead
\toprule\noalign{}
Phase & Purpose & Data basis & Claim supported \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\input{figures/fig_generic_node_example}
...
A complete numerical demonstration of source initialization, relation-level
contribution, bounded multi-source aggregation, current-state recursion, and
comparative ranking is provided in Appendix~\ref{app:worked-example}. The
worked example uses controlled dimensionless values solely to explain the
generic computation; it is not an operational measurement or an empirical
validation case.
...
\endfirsthead
\toprule\noalign{}
Network & Structure & Primary purpose \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
